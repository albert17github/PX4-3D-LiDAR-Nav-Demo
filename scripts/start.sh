...
echo "[1/5] Starting visible PX4 + Gazebo + LiDAR + DLIO + OctoMap stack..."
...
base_start_seconds=$((base_ready_epoch - startup_started_epoch))
...
echo "[2/5] Applying the PX4 no-GCS SITL policy while landed/disarmed..."
...
echo "      [timing] no_gcs_policy=${no_gcs_seconds}s"

echo "[3/5] Starting upstream MRS MinimalOctomapPlanner..."
...
echo "[4/5] Opening visible RViz window on desktop..."
...
echo "[5/5] Starting RViz video recording..."
